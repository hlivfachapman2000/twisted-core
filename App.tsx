...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-twisted-dark text-gray-200 selection:bg-twisted-blue selection:text-white overflow-x-hidden ${designerActive ? 'cursor-crosshair' : ''}`}>
      ...
      <header 
        className={`relative min-h-screen flex items-center justify-center overflow-hidden pt-20 transition-all duration-500 ${selectedElement === 'hero' ? 'bg-twisted-blue/5 animate-selected-pulse' : ''}`} 
      ...
      <main>
        <section id="products" className="py-32 relative bg-black/30">
            <div className="container mx-auto px-6">
                <div 
                  className={`text-center mb-24 transition-all ${selectedElement === 'products-header' ? 'scale-105 animate-selected-pulse text-twisted-blue' : ''}`} 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <ProductCard 
                        ...
                        isSelected={selectedElement === 'core-card'}
                    ...
                    <ProductCard 
                        ...
                        tags={['Real-Time', 'Flux']}
                        color="purple"
                        isSelected={selectedElement === 'command-card'}
                        onSelect={handleElementSelect}
                    />
                    <ProductCard 
                        id="dashboard-card"
                        ...
                        tags={['SwiftUI', 'Metal']}
                        color="green"
                        isSelected={selectedElement === 'dashboard-card'}
                        onSelect={handleElementSelect}
                    />
                    <ProductCard 
                        id="security-card"
                        ...
                        tags={['Ethical', 'SecOps']}
                        color="red"
                        isSelected={selectedElement === 'security-card'}
                        onSelect={handleElementSelect}
                    />
                </div>
            </div>
        ...
        <section 
          id="stack" 
          className={`py-32 bg-twisted-card border-y border-white/5 transition-colors ${selectedElement === 'infra-section' ? 'bg-twisted-blue/5 animate-selected-pulse' : ''}`} 
